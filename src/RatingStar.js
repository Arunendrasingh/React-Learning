    ...
    <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
      <div style={{ display: "flex", gap: "5px" }}>
        {Array.from({ length: stars }, (_, index) => (
          <Star ratingValue={index + 1} handleClick={handleRatingClick} onHover={handleHoverEffect} />
        ))}
      </div>
...
function Star({ ratingValue, handleClick, onHover }) {
  return (
    <span
      role="button"
      style={{
